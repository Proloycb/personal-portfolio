            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                <div class="card card-compact lg:max-w-lg bg-slate-900 text-white shadow-xl">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-actions pb-2">
                            <a href="https://manufacturer-website-a012f.web.app/" target="_blank"><button class="btn btn-xs btn-outline btn-secondary">Live Demo</button></a>
                ...
                <div class="card card-compact lg:max-w-lg bg-slate-900 text-white shadow-xl">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-actions pb-2">
                            <a href="https://gym-equipment-warehouse-7ae7e.web.app/" target="_blank"><button class="btn btn-xs btn-outline btn-secondary">Live Demo</button></a>
                ...
                <div class="card card-compact lg:max-w-lg bg-slate-900 text-white shadow-xl">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-actions pb-2">
                            <a href="https://independent-service-prov-c505a.web.app/" target="_blank"><button class="btn btn-xs btn-outline btn-secondary">Live Demo</button></a>
